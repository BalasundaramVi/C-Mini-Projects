...
void Pit::display() const
{
    ...
    {
        if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '.')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = 'S';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == 'S')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '2';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '2')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '3';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '3')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '4';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '4')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '5';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '5')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '6';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '6')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '7';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '7')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '8';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '8')
            grid[m_scorpions[i]->row()][m_scorpions[i]->col()] = '9';
        else if (grid[m_scorpions[i]->row()][m_scorpions[i]->col()] == '9')
            continue;
    }
